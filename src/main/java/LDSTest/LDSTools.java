...
public class LDSTools {
		...
		if (os.equals("android")) {
			...
			*/
			...
			if (testDevice.contains("STF")) {
				//String accessToken = "65a3bd54bc66464b9136008bf54146367d3444d071e2497f901166e0e6593362"; //Old Token
				String accessToken = "65a3bd54bc66464b9136008bf54146367d3444d071e2497f901166e0e6593362";
	...
	private void simpleTest(String os) throws Exception {
		...
		//YoungMenPresidentMissionary(os);
...
*/	
	...
	@Parameters({"os"})
	@Test (groups= {"medium", "medium1", "bishopric", "smoke", "all1"}, priority = 1)
	...
	@Parameters({"os"})
	@Test (groups= {"medium", "medium2", "bishopric", "smoke", "all1"}, priority = 1)
	...
	@Parameters({"os"})
	@Test (groups= {"medium", "medium3", "bishopric", "smoke", "all1"}, priority = 1)
	...
	@Parameters({"os"})
	@Test (groups= {"medium", "medium4", "bishopric", "smoke", "all1"}, priority = 1)
	...
	@Parameters({"os"})
	@Test (groups= {"medium", "medium1", "bishopric", "all2"}, priority = 1)
	...
	@Parameters({"os"})
	@Test (groups= {"medium", "medium2", "bishopric", "all2"}, priority = 1)
	...
	@Parameters({"os"})
	@Test (groups= {"medium", "medium3", "bishopric", "all2"}, priority = 1)
	public void Bishopric2ndCounselorReport(String os) throws Exception {
		LeaderBishopricReport("ngiBPC2", false, os); //Bishopric 2nd Counselor  
	}
	
	@Parameters({"os"})
	@Test (groups= {"medium", "medium4", "bishopric", "all2"}, priority = 1)
	...
	*/
	...
	@Parameters({"os"})
	@Test (groups= {"medium", "medium1", "bishopric", "all3"}, priority = 1)
	...
	@Parameters({"os"})
	@Test (groups= {"medium", "medium2", "bishopric", "all3"}, priority = 1)
	public void AssistantWardClerkMembershipMissionary(String os) throws Exception {
		LeaderBishopricDrawerOrgMissionary("ngiMC1", false, os); //Assistant Ward Clerk - Membership 
	}
	
	@Parameters({"os"})
	@Test (groups= {"medium", "medium3", "bishopric", "all3"}, priority = 1)
	public void AssistantWardClerkMembershipReport(String os) throws Exception {
		LeaderBishopricReport("ngiMC1", true, os); //Assistant Ward Clerk - Membership 
	}
	
	@Parameters({"os"})
	@Test (groups= {"medium", "medium4", "bishopric", "all3"}, priority = 1)
	...
	@Parameters({"os"})
	@Test (groups= {"medium", "medium4", "high priest", "myTest", "all4", "smoke1"}, priority = 1)
	public void HighPriestsGroupLeaderDirectory(String os) throws Exception {
		LeaderNonBishopricDirectory("LDSTools16", "High Priest Group", os);
	}
	
	@Parameters({"os"})
	@Test (groups= {"medium", "medium3", "high priest", "all4", "smoke2"}, priority = 1)
	...
	@Parameters({"os"})
	@Test (groups= {"medium", "medium2", "high priest", "all4", "smoke3"}, priority = 1)
	...
	@Parameters({"os"})
	@Test (groups= {"medium", "medium1", "high priest", "all4", "smoke4"}, priority = 1)
	...
	@Parameters({"os"})
	@Test (groups= {"medium", "medium2", "relief society", "all2", "smoke1"}, priority = 1)
	...
	@Parameters({"os"})
	@Test (groups= {"medium", "medium1", "relief society", "all2", "smoke2"}, priority = 1)
	...
	@Parameters({"os"})
	@Test (groups= {"medium", "medium4", "relief society", "all2", "smoke3"}, priority = 1)
	...
	@Parameters({"os"})
	@Test (groups= {"medium", "medium3", "relief society", "all2", "smoke4"}, priority = 1)
	...
	@Parameters({"os"})
	@Test (groups= {"medium", "medium4", "sunday school", "all3"}, priority = 1)
	public void SundaySchoolPresidentDirectory(String os) throws Exception {
		LeaderNonBishopricDirectory("LDSTools39", "Ward Council", os);
	}
	
	@Parameters({"os"})
	@Test (groups= {"medium", "medium3", "sunday school", "all3"}, priority = 1)
...
//**************************************************************
	...
	@Parameters({"os"})
	@Test (groups= {"medium", "medium1", "all1"}, priority = 1)
	...
	@Parameters({"os"})
	@Test (groups= {"medium", "medium3", "editSettings", "all2"}, priority = 1)
	...
	public void editVisibiltyHousehold(String os) throws Exception {
		...
		Assert.assertTrue(checkNoCaseList("1113334444", pageSource, "Contains"));
		//Assert.assertTrue(checkNoCaseList("PERSONAL", pageSource, "Equals"));
		Assert.assertFalse(checkNoCaseList("5551239999", pageSource, "Contains"));
	 ...
	 */
	@Parameters({"os"})
	@Test (groups= {"medium", "medium4", "all3"}, priority = 1)
	...
	@Parameters({"os"})
	@Test (groups= {"header", "medium", "medium1", "smoke2", "smoke", "all4"}, priority = 1)
	...
	*/
	...
	@Parameters({"os"})
	@Test (groups= {"medium", "medium2", "temple"}, priority = 1)
	...
	@Parameters({"os"})
	@Test (groups= {"medium", "medium3", "setings", "all1"}, priority = 1)
	...
	@Parameters({"os"})
	@Test (groups= {"addUnit", "smoke", "medium", "medium4", "all1"}, priority = 1)
	...
	@Parameters({"os"})
	@Test (groups= {"addUnit", "medium", "medium1", "all2"}, priority = 1)
	...
	@Parameters({"os"})
	@Test (groups= {"addUnit", "smoke", "medium", "medium2", "all3"}, priority = 1)
...
//			}
	...
	public void afterClass() throws Exception {
		if (!getRunningOS().equals("mac")) {
			...
			if (!deviceSerial.equals("")) {
				STFService mySTFService = new STFService("http://10.109.45.162:7100", "65a3bd54bc66464b9136008bf54146367d3444d071e2497f901166e0e6593362");
				DeviceApi myDevice = new DeviceApi(mySTFService);
				System.out.println("SERIAL NUMBER: " + deviceSerial);
	...
	public void remoteAuth() throws Exception {
		...
		Process pr = run.exec(new String[] {"/usr/bin/curl", 
				"-H",
				"\"Authorization: Bearer 65a3bd54bc66464b9136008bf54146367d3444d071e2497f901166e0e6593362\"", 
